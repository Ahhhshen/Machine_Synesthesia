...
for i, className in enumerate(classNames):
    ...
    #exclude temp files
    classFiles = [x for x in classFiles if not x.endswith('.DS_Store')]
...
writer.add_embedding(embedding, label_img=embedding_images, global_step=1)
